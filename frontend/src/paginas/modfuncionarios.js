    ...
    <Container fluid>
      ...
      <Col>
        ...
        <Form.Group as={Row} className="me-2" controlId="formBasicEmail">
          ...
          <Col sm={9}>
          <Form.Control type="text" placeholder="" value={funcionario.cpf}/>
          </Col>
        </Form.Group>
        <Form.Group as={Row} className="me-2" controlId="formBasicPassword">
          <Form.Label>Nome:</Form.Label>
          <Col sm={9}>
          <Form.Control type="text" placeholder="Password" value={funcionario.nome}/>
          </Col>
        </Form.Group>
        <Form.Group as={Row} className="me-2" controlId="formBasicPassword">
          <Form.Label>Cep:</Form.Label>
          <Col sm={9}>
          <Form.Control type="text" placeholder="Password" value={funcionario.cep}/>
          </Col>
          </Form.Group>
        <Form.Group as={Row} className="me-2" controlId="formBasicPassword">
...
export default Funcionariosmod;